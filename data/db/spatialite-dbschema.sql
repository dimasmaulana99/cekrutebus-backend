...
INSERT INTO users VALUES(1,'f00-fff-283e64-ffd400','94c5dde14d80','Webmap','webmap','dbf18c853fd1ea6c7ac9a12b685af866931aa427cf03439f6a252a4343534708','DASHBOARD',1);
...
CREATE TABLE "main_data" (
  ...
  "flag_extended"  INTEGER NOT NULL DEFAULT 0,
  "status"  INTEGER NOT NULL DEFAULT 0
);
...
CREATE TABLE "geo_multilinestring" (
  "gid"  INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  "codex"  TEXT,
  "context"  TEXT,
  "ownerid"  TEXT,
...
SELECT AddGeometryColumn('geo_point', 'geom', 4326, 'POINT', 'XY', 0);
SELECT AddGeometryColumn('geo_multipoint', 'geom', 4326, 'MULTIPOINT', 'XY', 0);
SELECT AddGeometryColumn('geo_linestring', 'geom', 4326, 'LINESTRING', 'XY', 0);
SELECT AddGeometryColumn('geo_multilinestring', 'geom', 4326, 'MULTILINESTRING', 'XY', 0);
SELECT AddGeometryColumn('geo_polygon', 'geom', 4326, 'POLYGON', 'XY', 0);
SELECT AddGeometryColumn('geo_multipolygon', 'geom', 4326, 'MULTIPOLYGON', 'XY', 0);
SELECT AddGeometryColumn('geo_geometry', 'geom', 4326, 'GEOMETRY', 'XY', 0);
SELECT AddGeometryColumn('geo_collection', 'geom', 4326, 'GEOMETRYCOLLECTION', 'XY', 0);
